<script>
  ...
  let steps = [
    {name: "Romi Store", icon: "fa-solid fa-shop"},
    {name: "Ultimate todos", icon: "fa solid fa-list-check"},
    {name: "pokedek", icon: "fa-solid fa-diagram-project"},
  ];

  let benefits = [
    {name: "A self developer", description: "loem ipsum dolor sit amet, consectetur adipiscing elit. Sed in arcu at neque semper consectetur."},
    {name: "a product design UI/UX", description: "lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed in arcu at neque semper consectetur."},
    {name: "an ecelent comunication", description: "lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed in arcu at neque semper consectetur."},
  ];
</script>

<main class="flex flex-col flex-1 p-4">
  <section id="introPage" class="grid grid-cols-1 lg:grid-cols-2 gap-10 py-8 sm:py-14">
    <div class="flex flex-col lg:justify-center text-center lg:text-left gap-6 md:gap-8 sm:gap-10">
      <h2 class="font-semibold text-3xl sm:text-4xl md:text-5xl">
        Hi! I'm <span class="poppins text-violet-400">Romi</span> Yusnandar <br /> Full Stack
        <span class="poppins text-green-400">Android</span> and <span class="poppins text-violet-400">Web </span>
        Developer.
      </h2>

      <p class="text-base sm:text-lg md:text-xl">
        My <span class="text-violet-400">favorite tech</span> includes JavaScript (NextJS
        or SvelteKIT), TailwindCSS, Node.js + Express.js & MySql or Firebase!
      </p>

      <a href="#" target="_blank" class="blueShadow mx-auto lg:mr-auto lg:ml-0 text-base sm:text-lg md:text-xl poppins relative overflow-hidden
    ...
    <div class="relative shadow-2xl grid place-items-center">
      <img src={"images/profile-nobg.png"} alt="Profile img" class="object-cover z-[2] max-h-[70vh]">
    </div>
  </section>
  ...
  <section id="projects" class="py-20 lg:py-32 flex flex-col gap-24">
    <div class="flex flex-col gap-2 text-center">
      ...
      <h3 class="font-semibold text-3xl sm:text-4xl md:text-5xl">
        Corius to <span class="poppins text-violet-400">see</span> my work?
      </h3>
    </div>
    <a href="https://github.com/romiyusnandar" target="_blank" class="mx-auto px-4 py-2 rounded-md border border-solid      border-white flex items-center gap-2 -mb-4 sm:-mb0 -mt-10 hover:border-violet-700 duration-200">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
      <Step step={steps[0]}>
        <p>
          Romiz Store is a lorem ipsum sit amet using <strong class="text-violet-400">Kotlin Language</strong>
          and more.
        </p>
      </Step>
  ...
  <section id="about" class="py-20 pt-10 lg:pt-16 lg:py-32 flex flex-col gap-16 sm:gap-20 md:gap-24 relative">
    ...
    after:h-1.5 after:bg-violet-700 py-4" >
      ...
      <h3 class="font-semibols text-3xl sm:text-4xl md:text-5xl">
